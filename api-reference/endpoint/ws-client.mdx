...
<script>
  var socket;
  var wsUrl = 'wss://api.sandbox.altpay.uk/ws/client';

  document.addEventListener('DOMContentLoaded', function () {
    var connectButton = document.getElementById('ws-connect');
    var status = document.getElementById('ws-connection');
    var output = document.getElementById('ws-output');

    connectButton.addEventListener('click', function () {
      var token = window.prompt("Enter your wsToken (from v2/auth/token response):");
